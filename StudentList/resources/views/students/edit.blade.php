...
<header class="mt-20 max-w-lg mx-auto">
   <a href="#">
   ...
   <section class="mt-10">
      ...
      <form action="/student/{{$student->id}}" method="POST" class="flex flex-col">
         ...
         <form action="" method="POST">
            @method('delete')
            @csrf
            <button type="submit" class="w-full mt-2 bg-red-500 hover:bg-red-400 text-gray-700 font-bold py-2 rounded shadow-lg hover:shadow-xl transitionduration-200" type="submit">Delete</button>
         </form>
   </section>
</main>
